...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,-----------------------------------------------------------.                      ,-----------------------------------------------------------.
      ALT,     ES_Q,     ES_W,     TD(AC_E), ES_R,     ES_T,                            ES_Y,      TD(AC_U), TD(AC_I), TD(AC_O), ES_P,     DEL,    \
  //|---------+---------+---------+---------+---------+---------|                      |----------+---------+---------+---------+---------+---------|
      CMD,     TD(AC_A), ES_S,     ES_D,     ES_F,     TD(G_DI),                        ES_H,      ES_J,     ES_K,     ES_L,     DEL,      ES_PLUS, \
  //|---------+---------+---------+---------+---------+---------|                      |----------+---------+---------+---------+---------+---------|
      CTR,     ES_Z,     ES_X,     ES_C,     ES_V,     ES_B,                            TD(ENYE),      ES_M,     ES_COMM,  DOT,      M5,       M6,  \
  //|---------+---------+---------+---------+---------+---------+---------|  |---------+----------+---------+---------+---------+---------+---------|
...
bool oled_task_user(void) {
    ...
    switch (get_highest_layer(layer_state)) {
        case _BASE:
            ...
            break;
        case _M1:
            oled_write_P(PSTR("M1\n"), false);
            break;
        case _M2:
            oled_write_P(PSTR("M2\n"), false);
            break;
        case _M3:
            oled_write_P(PSTR("M3\n"), false);
            break;
        case _M4:
            oled_write_P(PSTR("M4\n"), false);
            break;
        case _M5:
            oled_write_P(PSTR("M5\n"), false);
            break;
        case _M6:
            oled_write_P(PSTR("M6\n"), false);
            break;
        default:
